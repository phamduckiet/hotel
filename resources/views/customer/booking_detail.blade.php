                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4 flex-row-fluid">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>{{ __('messages.order_detail') }} (#{{ 'EG000' . $booking->id }})</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
                            <!--begin::Card body-->
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">{{ $booking->created_at->format('d/m/Y') }}
                                                </td>
                                            </tr>
                                            <!--end::Date-->
                                            <!--begin::Date-->
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">{{ $booking->updated_at->format('d/m/Y') }}
                                                </td>
                                            </tr>
                                            <!--end::Date-->
                                        </tbody>
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px overflow-hidden me-3">
                                                            <a>
                                                                <div class="symbol-label">
                                                                    <img
                                                                        src="{{ Avatar::create($booking->customer->name)->toBase64() }}" />
                                                                </div>
                                                            </a>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end">{{ $booking->customer->phone_number }}</td>
                                            </tr>
                                            <!--end::Date-->
                                        </tbody>
                                        <!--end::Table body-->
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                ...
                                <div style="margin-left:28px;">
                                    ...
                                    @elseif ($booking->status === 'delivered')
                                        <form method="POST"
                                            action="{{ route('orders.rate', ['order' => $booking->id]) }}">
                                            @csrf
                        ...
                        <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    <h2>{{ __('messages.order') }} #EG000{{ $booking->id }}</h2>
                                </div>
                            </div>
                            <!--end::Card header-->
                            <!--begin::Card body-->
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody class="fw-bold text-gray-600">
                                            {{-- @foreach ($booking->productVariants as $item)
                                                <!--begin::Products-->
                                                <tr>
                                                    <!--begin::Product-->
                                                    <td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">@money($booking->total - $booking->tax, 'VND')</td>
                                            </tr>
                                            <!--end::Subtotal-->
                                            <!--begin::VAT-->
                                            <tr>
                                                <td colspan="4" class="text-end">VAT (8%)</td>
                                                <td class="text-end">@money($booking->tax, 'VND')</td>
                                            </tr>
                                            <!--end::VAT-->
                                            <!--begin::Grand total-->
                                            <tr>
                                                ...
                                                <td class="text-dark fs-3 fw-boldest text-end">@money($booking->total, 'VND')</td>
                                            </tr>
                                            <!--end::Grand total-->
                                        </tbody>
                                        <!--end::Table head-->
