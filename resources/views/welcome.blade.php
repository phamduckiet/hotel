...
<!-- Mirrored from storage.googleapis.com/themevessel-items/hotel-alpha/rooms-col-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Jul 2018 11:21:33 GMT -->
<head>
    <!-- Google Tag Manager -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('hotel-alpha/fonts/font-awesome/css/font-awesome.min.css') }}">
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="hotel-alpha/img/favicon.ico" type="image/x-icon" >
...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area">
            <h1>Rooms 3 Column</h1>
            <ul class="breadcrumbs">
                <li><a href="index.html">Home</a></li>
                <li class="active">Rooms 3 Column</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    ...
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-2.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-3.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-5.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
                        ...
                        <h3>
                            <a href="rooms-details.html">Couple Room</a>
                        </h3>
                        <h5 class="location">
                            <a href="rooms-details.html">
                                <i class="fa fa-map-marker"></i>123 Kathal St. Tampa City,
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-4.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-1.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
                        ...
                        <h3>
                            <a href="rooms-details.html">Standard</a>
                        </h3>
                        <h5 class="location">
                            <a href="rooms-details.html">
                                <i class="fa fa-map-marker"></i>123 Kathal St. Tampa City,
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-8.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-7.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="hotel-box">
                    <!--header -->
                    <div class="header clearfix">
                        <img src="hotel-alpha/img/room/img-6.jpg" alt="room-col-4" class="img-responsive">
                    </div>
                    <!-- Detail -->
                    <div class="detail clearfix">
                        <div class="pr">
        ...
        <div class="text-center">
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    ...
                    <li><a href="rooms-col-1.html">1 <span class="sr-only">(current)</span></a></li>
                    <li><a href="rooms-col-2.html">2</a></li>
                    <li><a href="rooms-col-3.html">3</a></li>
                    <li class="active"><a href="rooms-col-4.html">4</a></li>
                    <li>
